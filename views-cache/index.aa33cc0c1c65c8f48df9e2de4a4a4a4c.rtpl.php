        ...
        <div class="row">
            ...
            <div class="col-md-7 col-12">
                ...
                <div class="bottom2">
                    ...
                    <h4>
                        Você certamente já viu essas informações ao lado em alguma parte do seu Navegador quando você <span class="color1">faz uma pesquisa,</span> pois é, esse é o <span class="color1">Google Meu Negócio.</span>
                    </h4>
                ...
                <div class="bottom5">
                    <h4>
                        E é isso que um <span class="color1">Especialista em Google Meu Negócio</span> faz pra você.
                    </h4>
                </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-12">
                ...
                <div class="bottom2">
                    <h4>
                        O Especialista recebe <u>permissão</u> para <span class="color1">para usar sua conta no Google Meu Negócio.</span>
                    </h4>
                </div>
        ...
        <div class="row align1">
            ...
            <div class="col-md-4 col-12 text-center centralizer bottom2">
                ...
                <div class="box3">
                    ...
                    <h4>Você não paga nada para aparecer no Google Meu Negócio, e pode receber visualizações de pessoas todos os dias, de forma gratuita</h4>
        ...
        <div class="row centralizer">
            ...
            <div class="col-md-8 col-12 text-center">  
                ...
                <div class="bottom2">
                    <h4>
                        <span class="size1">
                            Sim, você pode ter tudo isso, com a ajuda de um <span class="color1">Especialista em Google Meu Negócio!</span>
                        </span>
                    </h4>
                </div>
